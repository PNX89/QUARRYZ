...
def _resolves(claim: str) -> bool:
    ...
    `quarryz/thing.py` because that is the import path a reader types, and the file is at
    `src/quarryz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
